...
export class List extends RootCommand implements LeafCommand {
  ...
  @Option({ key: 'limit', type: 'number', describe: 'Limits the number of item returned.', default: 1000 })
  public limit!: number

  @Option({ key: 'offset', type: 'number', describe: 'Offset of the items returned.', default: 0 })
